    ...
    return (
      <div className="w-full">
        ...
        <select
          ref={ref}
          className={cn(
            'w-full px-4 py-2 border rounded-lg transition-all duration-200 bg-white dark:bg-gray-900',
            'text-gray-900 dark:text-gray-100',
            'focus:ring-2 focus:ring-[var(--accent-color)] focus:border-[var(--accent-color)] focus:outline-none',
